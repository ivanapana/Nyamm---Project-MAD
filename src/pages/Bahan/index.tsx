...
// (Sebelumnya bernama ResepDetail, diubah sesuai permintaan)
...
// Impor komponen-komponen atomik Anda
...
// Nama komponen diubah dari ResepDetail -> Bahan
const Bahan = () => {
  ...
  return (
    <ScrollView className="flex-1 bg-white" showsVerticalScrollIndicator={false}>
      {/* Set warna status bar agar sesuai dengan header */}
      ...
      <View className="bg-yellow-400 h-48 pt-10 px-5 relative">
        ...
        {/* Ikon Wajan (simulasi dari design) */}
        <View className="items-center justify-center mt-4">
          <View className="bg-purple-600 w-16 h-16 rounded-full items-center justify-center shadow-lg">
            ...
            <View className="bg-white w-6 h-5 rounded-full absolute" style={{ top: 20 }} />
            <View className="bg-yellow-400 w-3 h-3 rounded-full absolute" style={{ top: 24 }} />
          </View>
        </View>
      </View>
      ...
      <View className="bg-white -mt-10 rounded-t-3xl p-5 pt-6 pb-10">
        ...
        {/* Info Resep */}
        <Text className="text-2xl font-bold text-gray-900">Nasi Goreng Spesial</Text>
